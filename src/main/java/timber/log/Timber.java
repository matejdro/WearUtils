 ...
 * @author https://github.com/JakeWharton/timber */
public final class Timber {

    /**
     * AppTag used for {@link timber.log.Timber.AppTaggedDebugTree}
     */
    private static String appTag = "PebbleCompanionApplication";
    public static void setAppTag(String appTag)
    {
        Timber.appTag = appTag;
    }
    ...
    /**
     * A {@link timber.log.Timber.Tree} that sets tag to app name and includes actual tag in the message.
     ...
     */
    public static class AppTaggedDebugTree extends DebugTree
    {
        @Override
    ...
    public static class AndroidDebugTree extends AppTaggedDebugTree {
        private final boolean logEverything;

        public AndroidDebugTree(boolean logEverything) {
            this.logEverything = logEverything;
        }

        @Override
        protected void log(int priority, String tag, String message, Throwable t) {
            if (!logEverything && priority <= Log.INFO) {
                return;
            }
